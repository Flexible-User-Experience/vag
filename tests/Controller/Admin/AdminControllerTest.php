...
//            ['/ca/admin/equip/membre/export'],
            ['/ca/admin/blog/categoria/list'],
            ['/es/admin/blog/categoria/list'],
            ['/en/admin/blog/categoria/list'],
            ['/ca/admin/blog/categoria/create'],
            ['/ca/admin/blog/categoria/1/edit'],
//            ['/ca/admin/blog/categoria/export'],
            ['/ca/admin/blog/article/list'],
            ['/es/admin/blog/article/list'],
            ['/en/admin/blog/article/list'],
            ['/ca/admin/blog/article/create'],
            ['/ca/admin/blog/article/1/edit'],
//            ['/ca/admin/blog/article/export'],
...
//            ['/ca/admin/configuracio/usuari/export'],
    ...
    public function provideNotFoundUrls()
    {
        return [
            ...
            ['/ca/admin/equip/patrocinador/1/show'],
            ['/ca/admin/equip/patrocinador/1/delete'],
            ['/ca/admin/equip/membre/1/show'],
            ['/ca/admin/equip/membre/1/delete'],
            ['/ca/admin/blog/categoria/1/show'],
            ['/ca/admin/blog/categoria/1/delete'],
            ['/ca/admin/blog/article/1/show'],
